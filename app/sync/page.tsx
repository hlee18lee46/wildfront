...
export default function SyncPage() {
  ...
  const [carrier, setCarrier] = useState(""); // ✅ Required
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <iframe
              ...
              src="https://www.youtube.com/embed/4xm-w3BvRW4?si=h7DdawwVUav7Y_kb"
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <iframe
              className="w-full h-48 mb-4 rounded"
              src="https://www.youtube.com/embed/NwgGEV4C5kU?si=80qKbT1gg8-oeCTJ"
...
<div className="bg-white p-6 rounded-lg shadow-lg">
  <iframe
    className="w-full h-48 mb-4 rounded"
    src="https://www.youtube.com/embed/WntIInvOzk8?si=8PdEH59t0GzJszio"
